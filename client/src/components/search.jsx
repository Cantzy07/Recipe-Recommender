...
function SearchSavedCard({ card, isExpanded, onToggle }) {
...
export default function SavedPage({ cardData }) {
    ...
    <div className="search-container">
      <div className="search-wrapper">
        ...
        <div className="search-header">
          <h1 className="search-title">Card Search</h1>
          <p className="search-subtitle">Search through all cards by ID</p>
